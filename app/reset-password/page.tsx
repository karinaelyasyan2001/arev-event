...
export default function ResetPasswordPage() {
  ...
  async function handleUpdatePassword(
    ...
    if (error) {
      setError(
        "❌ Չհաջողվեց փոխել գաղտնաբառը։ Հնարավոր է՝ վերականգնման հղումը ժամկետանց է։"
      );
      return;
    }

    setMessage("✅ Գաղտնաբառը հաջողությամբ փոխվեց։");
        ...
        <div className="rounded-[32px] border border-black/[0.06] bg-white/95 p-6 shadow-[0_30px_90px_rgba(31,31,31,.12)] backdrop-blur-xl sm:p-9">
          ...
          <div className="text-center">
            ...
            <p className="mt-3 text-sm leading-7 text-neutral-500">
              Ստեղծեք նոր գաղտնաբառ ձեր Արև Իվենթ
              հաշվի համար։
            </p>
          </div>
